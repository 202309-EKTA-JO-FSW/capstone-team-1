  ...
  <div className="p-12 flex flex-col md:flex-row items-center">
    <div className="mr-0 md:mr-48 text-center md:text-left">
      ...
      <p className="text-lg md:text-xl mb-8">
        A food ordering website where you can experience<br /> the joy of
        culinary excellence as we deliver delight <br /> to your fingertips, one
        order at a time.
      </p>
    </div>
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
    <div className="bg-white rounded-2xl shadow-xl p-8 flex flex-col items-center justify-center aspect-square">
      ...
      <div className="text-center">
        <h2 className="text-lg font-semibold mb-2 text-main-green">ORDER ONLINE</h2>
        <p className="text-base text-gray-700">Explore menu & order online</p>
      </div>
    </div>
    <div className="bg-white rounded-2xl shadow-xl p-8 flex flex-col items-center justify-center aspect-square">
      <div className="mb-4">
      ...
      <div className="text-center">
        <h2 className="text-lg font-semibold mb-2 text-main-green">FAST DELIVERY</h2>
        <p className="text-base text-gray-700">Prompt delivery to you</p>
      </div>
    </div>
    <div className="bg-white rounded-2xl shadow-xl p-8 flex flex-col items-center justify-center aspect-square">
      <div className="mb-4">
      ...
      <div className="text-center">
        <h2 className="text-lg font-semibold mb-2 text-main-green">REACH AUDIENCE</h2>
        <p className="text-base text-gray-700">Expand online presence</p>
      </div>
    </div>
    <div className="bg-white rounded-2xl shadow-xl p-8 flex flex-col items-center justify-center aspect-square">
      <div className="mb-4">
      ...
      <div className="text-center">
        <h2 className="text-lg font-semibold mb-2 text-main-green">MANAGE ORDERS</h2>
  ...
  <div className="flex flex-col md:flex-row space-x-0 md:space-x-4">
    <div className="flex flex-col items-center mb-8">
      ...
      <div className="mt-4">
        ...
        committed to problem-solving and<br />
    ...
    <div className="flex flex-col items-center mb-8">
      ...
      <div className="mt-4">
        ...
        <p className="text-gray-600">
        Full-stack web developer from<br />
        Iraq, crafting dynamic user<br />
        experiences with expert UI<br />
    ...
    <div className="flex flex-col items-center mb-8">
      ...
      <div className="mt-4">
        ...
        <p className="text-gray-600">
        Passionate UX\UI Designer<br />
        Visual communication graduate<br />
    ...
    <div className="flex flex-col items-center mb-8">
      ...
      <div className="mt-4">
        ...
        CIS Grad | 2 Yrs Exp<br />
        Recoded Bootcamp Grad<br />
        Continuous Learner.
        </p>
      </div>
    </div>
